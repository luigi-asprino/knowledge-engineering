...
-  [Documentation](https://sparql-anything.readthedocs.io/en/latest/) (Please use the release [v0.9.0](https://github.com/SPARQL-Anything/sparql.anything/releases/tag/v0.9.0))
